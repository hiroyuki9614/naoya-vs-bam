...
export const fighters: Fighter[] = [
  {
    ...
    stance: 'Orthodox',
    country: 'Japan',
    weightClass: 'Undisputed Super Bantamweight Champion',
    ...
    timeline: [
      ...
      { year: '2023', event: 'WBA/IBF世界スーパーバンタム級王座獲得' },
  ...
  },
  {
    ...
    stance: 'Southpaw',
    country: 'USA',
    weightClass: 'Unified Super Flyweight Champion',
    ...
    timeline: [
      ...
      { year: '2023', event: 'IBF世界フライ級王座獲得 / フライ級2団体統一' },
      { year: '2024', event: 'WBC・The Ring世界スーパーフライ級王座獲得' },
